...
const ProtocolStackCards = () => {
  ...
  return <section id="how-it-works" className="relative overflow-hidden" style={{
    minHeight: '600px',
    zIndex: 1
  }}>
      {/* Section connector */}
      ...
      <div className="relative z-10 px-6 py-24 md:py-32">
        ...
        maxWidth: '1200px'
          ...
          <div className="flex flex-col md:flex-row gap-2 md:gap-3" style={{
          minHeight: '200px'
        }}>
            {cards.map((card, index) => {
            const isActive = activeIndex === index;
            return <motion.div key={card.id} onClick={() => handleCardClick(index)} className="relative cursor-pointer overflow-hidden" style={{
              borderRadius: '16px',
